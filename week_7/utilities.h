...
{
    float maximum = dataArray[0].bloodIron;
    int n;
    for (n = 1; n < numReadings; n++) {
        if (dataArray[n].bloodIron > maximum) {
            maximum = dataArray[n].bloodIron;
        }
    }
    return maximum;
}
...
{
    float minimum = dataArray[0].bloodIron;
    int n;
    for (n = 1; n < numReadings; n++) {
        if (dataArray[n].bloodIron < minimum) {
            minimum = dataArray[n].bloodIron;
        }
    }
    return minimum;
}
